<template>
  <div>
    <label>我们向 {{ phone }} {{ codeLength }}输入了一个验证码。请输入该验证码</label>

    <div class="ip-wrapper">
      <span class="input">
      <input type="tel" v-bind:maxlength="codeLength" @keyup="changeAuthCode" v-focus>
    </span>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      changeAuthCode: function (e) {
        this.$emit('getAuthCode', e.target.value)
      }
    }
  }
</script>
